 ...
 * generated in the iti.hadeer.employeeservices package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddEmployee_QNAME = new QName("http://hadeer.iti/", "addEmployee");
    private final static QName _AddEmployeeResponse_QNAME = new QName("http://hadeer.iti/", "addEmployeeResponse");
    private final static QName _DeleteEmployee_QNAME = new QName("http://hadeer.iti/", "deleteEmployee");
    private final static QName _DeleteEmployeeResponse_QNAME = new QName("http://hadeer.iti/", "deleteEmployeeResponse");
    private final static QName _GetEmployee_QNAME = new QName("http://hadeer.iti/", "getEmployee");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://hadeer.iti/", "getEmployeeResponse");
    private final static QName _UpdateEmployee_QNAME = new QName("http://hadeer.iti/", "updateEmployee");
    private final static QName _UpdateEmployeeResponse_QNAME = new QName("http://hadeer.iti/", "updateEmployeeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: iti.hadeer.employeeservices
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "addEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "addEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "deleteEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "deleteEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "getEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "getEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "updateEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://hadeer.iti/", name = "updateEmployeeResponse")
